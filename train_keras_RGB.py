...
parser.add_argument("--epochs", help="Number of epochs to train", default=70)
...
train_data_dir = './Join_Canny_Caltech101/TRAIN' #'./Canny_Caltech101/TRAIN'
validation_data_dir = './Event_Caltech101/TEST'
nb_train_samples=72987
